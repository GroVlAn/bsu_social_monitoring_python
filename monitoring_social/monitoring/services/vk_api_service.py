...
# print('vlad' in [thread.name for thread in threading.enumerate()])
# new_thread = threading.Thread(target=worker, name='vlad')
# new_thread.start()
# while True:
#     print('vlad' in [thread.name for thread in threading.enumerate()])
...
elapsed_time = datetime.timedelta(seconds=int(end_time - start_time))

print("Elapsed time:", str(elapsed_time))
print("Elapsed time formatted:", elapsed_time)
