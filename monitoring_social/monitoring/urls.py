...
from monitoring.views.settings_view import SettingsPage, UserSettingsView, SearchItemsSettingsView, GroupsSettingsView
...
urlpatterns = [
    ...
    path('settings/items/edit/<int:id>',
         CreateSearchItem.as_view(template_name='pages/monitoring/edit/index.html'), name='edit_search_item'),
    ...
    path('monitoring/grop/create/<int:id>',
         GroupSearchItemsFormView.as_view(template_name='pages/settings/monitoring/groups/edit/index.html'),
