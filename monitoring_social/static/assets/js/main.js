...
var menu = document.querySelector('.js_left_menu');
var closeMenu = document.querySelector('.js_close_menu');
console.log(1);
closeMenu.addEventListener('click', function (el) {
  console.log(2);
...
organizationsSelect.addEventListener('change', function (e) {
  ...
  var request = new Request(target.dataset.url, {
    method: 'POST',
    headers: {
      'X-CSRFToken': target.dataset.token,
